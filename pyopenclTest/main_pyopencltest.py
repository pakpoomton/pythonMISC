...
class CL:
    ...
    def loadProgram(self, filename):
        ...
        print "Here is the program we are running:"
        print " "
        print fstr
        print " "
        #create the program
...
impofd        self.a_buf = cl.Buffer(self.ctx, mf.READ_ONLY | mf.COPY_HOST_PTR, hostbuf=self.a)
    ...
    def execute(self):
        ...
        c = numpy.empty_like(self.a) # make empty array of size a
        cl.enqueue_read_buffer(self.queue, self.dest_buf, c).wait() # read from dest_buf to c
        print "a", self.a
        print "b", self.b
        print "c", c
