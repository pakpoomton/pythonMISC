...
Q1 = int(3*Nz/12) # location 1/4 from left or top
Q3 = int(9*Nz/12) # location 3/4 from left or top
...
for i in range(1, Nt):
    ...
    T[i,Q1,Q1] = T[i-1,Q1,Q1] + prod # add heat
    T[i,Q3,Q3] = T[i-1,Q3,Q3] + prod # add heat
    T[i,Q1,Q3] = T[i-1,Q1,Q3] + deg*T[i-1,Q1,Q3] # remove heat
    T[i,Q3,Q1] = T[i-1,Q3,Q1] + deg*T[i-1,Q3,Q1] # remove heat
